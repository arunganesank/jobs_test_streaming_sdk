    ...
    def execute(self):
        ...
        if self.process is None:
            ...
            if self.args.streaming_type == StreamingType.AMD_LINK:
                self.process = start_streaming(self.args.execution_type, streaming_type=self.args.streaming_type, case=self.case, socket=self.sock, debug_screen_path=debug_screen_path)
